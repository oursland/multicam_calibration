...
#
    ...
    def do_calibration(self, req, resp):
        ...
        try:
            ...
            self.set_p(FIX_INTRINSICS, "cam3", True)
            self.set_p(FIX_EXTRINSICS, "cam3", True)
            self.set_p(SET_ACTIVE,     "cam3", False)
            self.set_p(FIX_INTRINSICS, "cam4", True)
            self.set_p(FIX_EXTRINSICS, "cam4", True)
            self.set_p(SET_ACTIVE,     "cam4", False)
            self.set_p(FIX_INTRINSICS, "cam5", True)
            self.set_p(FIX_EXTRINSICS, "cam5", True)
            self.set_p(SET_ACTIVE,     "cam5", False)
            self.set_p(FIX_INTRINSICS, "cam6", True)
            self.set_p(FIX_EXTRINSICS, "cam6", True)
            self.set_p(SET_ACTIVE,     "cam6", False)
            self.run_cal()
            ...
            self.set_p(FIX_EXTRINSICS, "cam2", True)
            self.set_p(SET_ACTIVE,     "cam2", False)
            self.set_p(FIX_INTRINSICS, "cam3", False)
            self.set_p(FIX_EXTRINSICS, "cam3", True)
            self.set_p(SET_ACTIVE,     "cam3", True)
            self.set_p(FIX_INTRINSICS, "cam4", True)
            self.set_p(FIX_EXTRINSICS, "cam4", True)
            self.set_p(SET_ACTIVE,     "cam4", False)
            self.set_p(FIX_INTRINSICS, "cam5", True)
            ...
            self.set_p(FIX_EXTRINSICS, "cam3", True)
            self.set_p(SET_ACTIVE,     "cam3", False)
            self.set_p(FIX_INTRINSICS, "cam4", False)
            self.set_p(FIX_EXTRINSICS, "cam4", True)
            self.set_p(SET_ACTIVE,     "cam4", True)
            self.set_p(FIX_INTRINSICS, "cam5", True)
            self.set_p(FIX_EXTRINSICS, "cam5", True)
            self.set_p(SET_ACTIVE,     "cam5", False)
            self.set_p(FIX_INTRINSICS, "cam6", True)
            ...
            self.set_p(FIX_EXTRINSICS, "cam4", True)
            self.set_p(SET_ACTIVE,     "cam4", False)
            self.set_p(FIX_INTRINSICS, "cam5", False)
            self.set_p(FIX_EXTRINSICS, "cam5", True)
            self.set_p(SET_ACTIVE,     "cam5", True)
            self.set_p(FIX_INTRINSICS, "cam6", True)
            self.set_p(FIX_EXTRINSICS, "cam6", True)
            self.set_p(SET_ACTIVE,     "cam6", False)
            self.run_cal()
            # then do intrinsics of cam6
            self.set_p(FIX_INTRINSICS, "cam1", True)
            self.set_p(FIX_EXTRINSICS, "cam1", True)
            self.set_p(SET_ACTIVE,     "cam1", False)
            self.set_p(FIX_INTRINSICS, "cam2", True)
            ...
            self.set_p(FIX_EXTRINSICS, "cam5", True)
            self.set_p(SET_ACTIVE,     "cam5", False)
            self.set_p(FIX_INTRINSICS, "cam6", False)
            self.set_p(FIX_EXTRINSICS, "cam6", True)
            self.set_p(SET_ACTIVE,     "cam6", True)
            self.run_cal()
